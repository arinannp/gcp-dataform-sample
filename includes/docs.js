...
const columns = {
    farm_id: `A unique identifier for a user`,
    ph: `The age of a user`,
    moisture: `The date this user signed up`,
    organic_matter: `The number of years since the user's creation date`,
    ingestion_timestamp: `The all-time number of badges the user has received`,
};
